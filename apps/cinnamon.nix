...

{
  dconf.settings = {
    "org/cinnamon" = {
      ...
      next-applet-id = 15;
      panel-zone-icon-sizes = "[{\"panelId\": 1, \"left\": 0, \"center\": 0, \"right\": 32}]";
      panel-zone-symbolic-icon-sizes = "[{\"panelId\": 1, \"left\": 48, \"center\": 32, \"right\": 32}]";
    ...
    "org/cinnamon/desktop/interface" = {
      ...
      font-name = "Monospace 8";
      gtk-theme = "Mint-Y-Dark-Teal";
      icon-theme = "Mint-Y-Teal";
      text-scaling-factor = 1.6000000000000005;
    };
    ...
    "org/cinnamon/settings-daemon/plugins/color" = {
      night-light-last-coordinates = mkTuple [ 43.39 (-79.23) ];
    };
